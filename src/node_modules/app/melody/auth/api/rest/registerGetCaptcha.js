...
const who = [config.namespace, config.entity, `api`, `rest`, `registerGetCaptcha`]
...
export default async (payload, options = {}) => {
  try {
    ...
    const response = await fetch(`${host}/user/register/pictureCode?machineNo=${machineNo}`)
