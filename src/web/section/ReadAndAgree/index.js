...
const enhance = compose(
  ...
  defaultProps({
    ...
    TypographyCustom: styled(Typography)`
      && {
        margin: ${rem(16)} auto;
...
const ReadAndAgree = enhance(({TypographyCustom, Title, readAndAgree, onChangeReadAndAgree, LabelInline} ) => {
  return (
    <React.Fragment>

          <Grid item xs={10} md={8}>
            <Title>让设计落实的产品</Title>
          </Grid>

          <Grid item xs={10} md={10}>
           <TypographyCustom>
            一、总则
              1.1 美工场的所有权和运营权归上海市美工场科技有限公司所有。 
              1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与美工场之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。 
              1.3 本协议则可由美工场随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。
           </TypographyCustom>
           <TypographyCustom>
            二、服务内容
              2.1 美工场的具体内容由本站根据实际情况提供。 
              2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。
           </TypographyCustom>
           <TypographyCustom>
            三、用户帐号
              3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。美工场有权对会员的权限设计进行变更。 
              3.2 用户只能按照注册要求使用真实姓名，及手机号注册。用户有义务保证密码和帐号的安全，用户利用该密码和帐号所进行的一切活动引起的任何损失或损害，由用户自行承担全部责任，本站不承担任何责任。如用户发现帐号遭到未授权的使用或发生其他任何安全问题，应立即修改帐号密码并妥善保管，如有必要，请通知本站。因黑客行为或用户的保管疏忽导致帐号非法使用，本站不承担任何责任。
           </TypographyCustom>
           <TypographyCustom>
            四、使用规则
           ...
           <TypographyCustom>
            六、版权声明
              6.1 本站的文字、图片、音频、视频等版权均归美工场科技有限公司享有或与作者共同享有，未经本站许可，不得任意转载。 
              6.2 本站特有的标识、版面设计、编排方式等版权均属美工场科技有限公司享有，未经本站许可，不得任意复制或转载。 
              6.3 使用本站的任何内容均应注明“来源于美工场”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。
          ...
          八、附则
              ...
              8.3 本协议解释权及修订权归上海美工场科技有限公司所有。
           </TypographyCustom>

           <Grid item xs={4} md={4} style={{margin: '0 auto', textAlign: 'center'}}>
              <FormGroupCustom row>
                <FormControlLabel
                  control={
                    <Checkbox
                  ...
                  label={<React.Fragment><LabelInline>我已阅读并接受用</LabelInline>
                  </React.Fragment>}
                  />
              </FormGroupCustom>
            ...
            <Grid item xs={4} md={4} style={{margin: '0 auto', textAlign: 'center'}}>
              <SubmitButton variant="contained" color="primary" color="primary"  disabled={!readAndAgree}>上一页</SubmitButton>
            </Grid>
